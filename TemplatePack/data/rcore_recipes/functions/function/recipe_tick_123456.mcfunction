...
execute if block ~ ~ ~ minecraft:dropper[facing=down]{Items:[{id:"minecraft:stone",Count:1b,Slot:1b},{id:"minecraft:stone",Count:1b,Slot:4b},{id:"minecraft:stone",Count:1b,Slot:7b}]} run function rcore_recipes:output